...
function(MAYA_PLUGIN target)
    ...
    set(MAYA_TBB_LIBRARY tbb)
    if(WIN32)
        if((DEFINED MAYA_VERSION AND MAYA_VERSION VERSION_GREATER_EQUAL "2026")
           OR (EXISTS "${MAYA_DEVKIT_DIR}/lib/tbb12.lib" AND NOT EXISTS "${MAYA_DEVKIT_DIR}/lib/tbb.lib"))
            set(MAYA_TBB_LIBRARY tbb12)
        endif()
    endif()

    set(MAYA_LIBS Foundation OpenMaya OpenMayaAnim OpenMayaFX OpenMayaRender OpenMayaUI clew ${MAYA_TBB_LIBRARY})
