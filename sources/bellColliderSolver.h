...
{
public:
  static MPointArray makeBellPoints(const MMatrix &matrix, unsigned int axis, unsigned int numSides, double height = 1,
                                    double bottomRadius = 1, double topRadius = 1);
  static MObject makeBellMesh(const MPointArray &points, unsigned int numSides);
